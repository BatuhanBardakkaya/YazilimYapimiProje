...
namespace Temel6SigmaQuizSorularınınBelirlenmeAlgoritması
{
    ...
    {   // Data Source=LAPTOP-D3S9ESL2;Initial Catalog=altiSigmaProblemi;Integrated Security=True
        ...
        int MValX;
        int MValY;
        private void frm_kayitOl_MouseDown(object sender, MouseEventArgs e)
        {
        ...
        private void frm_kayitOl_MouseUp(object sender, MouseEventArgs e)
        {
            TogMove = 0;
        }

        private void frm_kayitOl_MouseMove(object sender, MouseEventArgs e)
        {
            if (TogMove == 1)
            {
