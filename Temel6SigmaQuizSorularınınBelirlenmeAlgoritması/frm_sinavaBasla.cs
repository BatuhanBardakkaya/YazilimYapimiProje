...
{
    public partial class frm_sinavaBasla : Form
    {
        public frm_sinavaBasla()
        {
            InitializeComponent();
        }
        ...
        {
            //if (btn_isaretle.ButtonText != "Soruları Göster")
            //{
        ...
        int MValX;
        int MValY;
        private void frm_sinavaBasla_MouseDown(object sender, MouseEventArgs e)
        {
            TogMove = 1;
            MValX = e.X;
            MValY = e.Y;
        ...
        private void frm_sinavaBasla_MouseUp(object sender, MouseEventArgs e)
        {
            TogMove = 0;
        }

        private void frm_sinavaBasla_MouseMove(object sender, MouseEventArgs e)
        {
            if (TogMove == 1)
            {
        ...
        private void frm_sinavaBasla_Load(object sender, EventArgs e)
        {
